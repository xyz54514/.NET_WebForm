...
namespace DataAccess
{
    public class Database
    {
        ...
        public int ExecuteNonQuery(DbCommand dbCommand, SqlConnection dbConnection)
        {
            ...
            try
            {
                iEffectCnt = this.ExecuteNonQuery(dbCommand, dbConnection, null);
        ...
        public int ExecuteNonQuery(DbCommand dbCommand)
        {
            ...
            try
            {
                iEffectCnt = this.ExecuteNonQuery(dbCommand, null);
        ...
        public object ExecuteScalar(DbCommand dbCommand, SqlConnection dbConnection, SqlTransaction dbTransaction)
        {
            object oEffectCnt;
            ...
            {
                throw new Exception("ExecuteScalar::" + ex.ToString());
            }
            finally
            {
            }
        ...
        public object ExecuteScalar(DbCommand dbCommand, SqlConnection dbConnection)
        {
            ...
            try
            {
                oEffectCnt = this.ExecuteScalar(dbCommand, dbConnection, null);
        ...
        public object ExecuteScalar(DbCommand dbCommand)
        {
            ...
            try
            {
                oEffectCnt = this.ExecuteScalar(dbCommand, null);
