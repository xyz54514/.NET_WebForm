<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checker.aspx.cs" Inherits="WebForm.Form.Checker" StylesheetTheme="WebForm" %>
                                ...
                                <asp:GridView ID="gvList" runat="server" Width="100%" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <asp:Button ID="btnReject" runat="server" Text="Reject" CommandName="Reject" CommandArgument='<%# Eval("PID") %>' 
                                                    OnClientClick="return confirm('確定要退回?');" />
                                                <asp:Button ID="btnApprove" runat="server" Text="Approve" CommandName="Approve" CommandArgument='<%# Eval("PID") %>' 
