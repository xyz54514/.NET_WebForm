<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Maker.aspx.cs" Inherits="WebForm.Form.Maker" StylesheetTheme="WebForm" %>
                                ...
                                <asp:GridView ID="gvList" runat="server" Width="100%" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <asp:Button ID="btnModify" runat="server" Text="Modify" CommandName="Modify" CommandArgument='<%# Eval("PID") %>' />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="21%" />
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="ProductName" DataField="ProdName" />
                            ...
                            <asp:Panel ID="plSet" runat="server" GroupingText="Add" Width="99%">
                                <table style="text-align:left;" width="100%">
                                    <tr>
                                        ...
                                        <td class="ms-formlabel">
                                            <asp:Label ID="lblSetPrice" runat="server" Text="Price" />
                                        </td>
                                        <td class="ms-formbody">
                                            <asp:TextBox ID="txtSetPrice" runat="server" Width="30%" onkeypress="return isNumberKey(event)" />
                                        </td>
                                    </tr>
                                </table><br />
