...
{
    public partial class myChecker : basePage
    {
        #region variable
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                objLogExpBiz.InsertLogExp("myChecker", "Page_Load", ex);
        ...
        protected void HandleOrder(string status, int key)
        {
        ...
        protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                LogExpBiz objLogExpBiz = new LogExpBiz();
                objLogExpBiz.InsertLogExp("myChecker", "gvList_RowCommand", ex);
        ...
        protected void gvListBind()
        {
            ...
            //取得資料數量
            OrderBiz objOrderBiz = new OrderBiz();
            int rowCount = objOrderBiz.InqOrderCountChecker(name, time);
            ...
            //向DB查詢資料
            DataTable dt = objOrderBiz.InqOrderChecker(name, time, tStartRow, tEndRow);
